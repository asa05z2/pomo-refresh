...
PomoRefreshへ追加したフリー音源の配布元とライセンスを記録します。以下の10件はいずれもCC0（パブリックドメイン提供）で、商用利用・改変・再配布が許可されています。Freesoundの音源には配布元が提供するブラウザ試聴用MP3、OpenGameArtの音源には配布元が提供するMP3を使用しています。

| アプリ内表示 | ファイル | 原音源・作者 | 配布元 | ライセンス |
| :--- | :--- | :--- | :--- | :--- |
| 3分専用BGM | `3min.mp3` | City Loop / wipics | [OpenGameArt](https://opengameart.org/content/city-loop-0) | [CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/) |
...
| ウクレレ | `ukulele.mp3` | ukewave.wav / yourliver | [Freesound](https://freesound.org/people/yourliver/sounds/238076/) | [CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/) |
| ギター | `acoustic_guitar.mp3` | A Small Fire Will Do (Calming Loop) / Trex0n (Cal McEachern) | [OpenGameArt](https://opengameart.org/content/a-small-fire-will-do-calming-loop) | [CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/) |

クレジット表記は必須ではありませんが、作者への敬意と取得経路の追跡のため本一覧を維持します。ライセンスは既存5件を2026年8月7日、差し替えた5件を2026年8月20日に各配布ページで確認しました。
